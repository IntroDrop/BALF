...
from CenterNet.src.opts_and_utils import _gather_feat, _transpose_and_gather_feat, all_opts
    ...
    def run(self, image_path):
        ...
        for det in np.array(dets[-1]):
            ...
            if det[4] > 0.3:
                ...
                cv2.putText(image, str(det[4]), (det[0], det[1]), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 1)
                # print(det[4])
